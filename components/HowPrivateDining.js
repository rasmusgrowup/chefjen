...
export default function HowPrivateDining({ title }) {
  return (
    <>
      <section className={css.howWrapper}>
        ...
        <div className={css.faq}>
          ...
          <div className={css.questions}>
            <Faq title='Leje af kok' text='Chef Jen følger maden og slut-tilbereder menuerne hos jer. Han tallerkenanretter maden efter dine ønsker og efter aftale. Pris DKK 495 pr. time (minimum 5 timer) Bemærk, at der beregnes transporttid for både kok og personale.' />
            ...
            <Faq title='Bestillings- og betalingsfrist' text='Private dining kan senest bestilles 7 dage inden leveringsdagen. Betalingen afregnes via en tilsendt faktura som har 7 dages betalingsfrist, når vi har afsluttet vores service hos dig.' />
            <Faq title='Fødevareallergi' text='Vedrørende fødevareallergi opfordres du til at kontakte personalet, som vil gøre alt for at hjælpe. Chef Jen ApS påtager sig intet ansvar for eventuelle allergiske reaktioner.' />
            <Faq title='Afbestilling' text='Afbestilling skal ske skriftligt på kontaktformchefjen@gmail.com, og skal være givet minimum 5 hverdage før det aftalte leveringstidspunkt. Ved afbestilling modtager du en bekræftelse på, at afbestillingen er modtaget. Læs vores handelsbetingelser for at se vores fulde afbestillingsbetingelser. Find vores handelsbetingelser i bunden af siden.' />
          </div>
        </div>
      </section>
    </>
